...
承接已合并的 [#1468](https://github.com/zhu1090093659/dsh-web/pull/1468)（blue-fantasy 插画背景下的文字可读性层），这轮补五处：
...
3. **表格托底贴合内容宽度** —— 壳层表格外层容器默认撑满整栏，而表格本身贴内容宽度，短表格旁边会空出约 **300px** 的空玻璃。
